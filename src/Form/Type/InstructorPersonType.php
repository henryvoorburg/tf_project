...
class InstructorPersonType extends AbstractType
{
...
//            ])
            ->add('gender', ChoiceType::Class, ['attr' => ['class' => "form-control"], 'choices' => ['Man' => 'Man', 'Vrouw' => "Vrouw"]])
...
//            ->add('enabled', ChoiceType::class, ['choices' => [
//                'Ingeschakeld' => '1',
//                'Uitgeschakeld' => '0'
//            ]])
